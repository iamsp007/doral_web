                            ...
                            <tr>
                                <td valign="top" class="hc_aside">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td align="center" class="hc_txt_20" style="font-family:Montserrat, Arial, sans-serif; font-size:24px; font-weight:700; line-height:26px; color:#24272A;">Hi {{ $full_name }},</td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;"> The report shown below is getting expired. Please renew your medical reports.</td>
                                            </tr>
                                            <tr>
                                                <td height="30" class="hc_height">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <table width="600" cellpadding="0" cellspacing="0" border="1" align="center" class="hc_main_table" style="table-layout:fixed;">
                                                    <thead>
                                                        <tr>
                                                            <th>Report Type</th>
                                                            <th>Due Date</th>
                                                    ...
                                                    <tbody>
                                                        @foreach($detail as $data)
                                                            <tr>
                                                                <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">{{$data->labReportType->name}}</td>
                                                                <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;"> {{$data->due_date}}</td>
                                                                <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;"> {{$data->result}}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
