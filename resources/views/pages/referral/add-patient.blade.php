...
<!--							<li id="finish"><strong>Questions 3</strong></li>
						...
						<fieldset class="form-card pb-4">
                                                    <div class="pl-4 pr-4 pb-4 pt-4">
                                                        <h2 class="fs-title">Please Select Doral Service</h2>
                                                        <div class="d-flex justify-content-center align-items-center mt-4">
                                                                <div class="custom-control custom-radio mr-3">
                                                                    <input disabled="" type="radio" id="service1" name="service"
                                                                                value="1" class="custom-control-input">
                                                                        <label class="custom-control-label" for="service1">VBC</label>
                                                                </div>
                                                                <div class="custom-control custom-radio mr-3">
                                                                    <input disabled="" type="radio" id="service2" name="service"
                                                                                value="2" class="custom-control-input">
                                                                        <label class="custom-control-label" for="service2">MD Order</label>
                                                                </div>
                                                                <div class="custom-control custom-radio mr-3">
                                                                    <input checked="" type="radio" id="service3" name="service"
                                                                                value="3" class="custom-control-input">
                                                                        <label class="custom-control-label" for="service3">Occupational Health</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input disabled="" type="radio" id="service4" name="service"
                                                                                value="4" class="custom-control-input">
                                                                        <label class="custom-control-label" for="service4">Tele Health</label>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <input type="button" name="next" class="next cancel-btn m-auto" id="service"
