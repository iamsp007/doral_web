<div class="tab-pane fade" id="annual-health-assessment" role="tabpanel" aria-labelledby="annual-health-assessment-tab">
    <div class="app-vbc p-3">
        <div class="add-new-patient">
            <div class="icon">
                <img src="{{ asset('assets/img/icons/annual_health_management.svg') }}" class="img-fluid" />
            </div>
            <button type="submit" class="btn btn-outline-green w-600 d-table mr-auto ml-auto mt-3" id="annualbtn"
                    style="width: inherit;font-size: 18px;height: 36px;padding-left: 10px;padding-right: 10px;text-transform: uppercase;"
                    onclick="openRoadL('annualbtn')" name="RoadL Request">RoadL Request
            </button>   
                            ...
                            <tr class="explode1 d-none">
                                <td colspan="6">
                                    <div class="pt-3 _title1">Your Report is
                                        ...
                                        <p class="mt-3 text-green">You need to have <span class="text-underline">Chest X-Ray report</span>.</p>
                                    </div>
