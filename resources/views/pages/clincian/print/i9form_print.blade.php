...
<!--                                 <img
         ...
         <tr>
            <td>
                <table style="margin-top: -8px;" class="border">
                  <tr>
                     <td class="text-center">
                        <table class="table-border mr-top-10px mr-bottom-5px" style="margin-top: 3px;">
                           <tr>
                              <td>
                                 Document Title :<br />
                                 <span>{{ isset($employer_verify['doc_title_1']) ? $employer_verify['doc_title_1'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Issuing Authority :<br />
                                 <span>{{ isset($employer_verify['issuing_authority_1']) ? $employer_verify['issuing_authority_1'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Document Number :<br />
                                 <span>{{ isset($employer_verify['document_number_1']) ? $employer_verify['document_number_1'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Expiration Date <em>(if any)</em
                                    ><em>(mm/dd/yyyy)</em> : <br /> {{ isset($employer_verify['expiration_date_1']) ? $employer_verify['expiration_date_1'] : '' }}
                              </td>
                           </tr>
                        </table>
                        <table class="table-border mr-bottom-5px">
                           <tr>
                              <td>
                                 Document Title :<br />
                                 <span>{{ isset($employer_verify['doc_title_2']) ? $employer_verify['doc_title_2'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Issuing Authority :<br />
                                 <span>{{ isset($employer_verify['issuing_authority_2']) ? $employer_verify['issuing_authority_2'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Document Number :<br />
                                 <span>{{ isset($employer_verify['document_number_2']) ? $employer_verify['document_number_2'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Expiration Date <em>(if any)</em
                                    ><em>(mm/dd/yyyy)</em> : <br />{{ isset($employer_verify['expiration_date_2']) ? $employer_verify['expiration_date_2'] : '' }}
                              </td>
                           </tr>
                        </table>
                        <table class="table-border mr-bottom-5px">
                           <tr>
                              <td>
                                 Document Title :<br />
                                 <span>{{ isset($employer_verify['doc_title_3']) ? $employer_verify['doc_title_3'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Issuing Authority :<br />
                                 <span>{{ isset($employer_verify['issuing_authority_3']) ? $employer_verify['issuing_authority_3'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Document Number :<br />
                                 <span>{{ isset($employer_verify['document_number_3']) ? $employer_verify['document_number_3'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Expiration Date <em>(if any)</em
                                    ><em>(mm/dd/yyyy)</em> :<br />{{ isset($employer_verify['expiration_date_3']) ? $employer_verify['expiration_date_3'] : '' }}
                              </td>
                           </tr>
                        </table>
                     </td>
                     <td class="text-center">
                        <table class="table-border mr-top-10px mr-bottom-10px" style="margin-top: 3px;">
                           <tr>
                              <td>
                                 Document Title :<br />
                                  <span>{{ isset($employer_verify['doc_title_4']) ? $employer_verify['doc_title_4'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Issuing Authority :<br />
                                  <span>{{ isset($employer_verify['issuing_authority_4']) ? $employer_verify['issuing_authority_4'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Document Number :<br />
                                  <span>{{ isset($employer_verify['document_number_4']) ? $employer_verify['document_number_4'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Expiration Date <em>(if any)</em
                                    ><em>(mm/dd/yyyy)</em> : <br />{{ isset($employer_verify['expiration_date_4']) ? $employer_verify['expiration_date_4'] : '' }}
                              </td>
                           </tr>
                        </table>
                        <table class="table-border" style="margin-top: 40px">
                           <tr>
                              ...
                              >
                                 ...
                                 <span>{{ isset($employer_verify['addition_info']) ? $employer_verify['addition_info'] : '' }}</span>
                              </td>
                           </tr>
                        </table>
                     </td>
                     <td class="text-center">
                        <table class="table-border mr-top-10px mr-bottom-10px" style="margin-top: 3px;">
                           <tr>
                              <td>
                                 Document Title :<br />
                                  <span>{{ isset($employer_verify['doc_title_5']) ? $employer_verify['doc_title_5'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Issuing Authority :<br />
                                 <span>{{ isset($employer_verify['issuing_authority_5']) ? $employer_verify['issuing_authority_5'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Document Number :<br />
                                  <span>{{ isset($employer_verify['document_number_5']) ? $employer_verify['document_number_5'] : '' }}</span>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 Expiration Date <em>(if any)</em
                                    ><em>(mm/dd/yyyy)</em> : <br />{{ isset($employer_verify['expiration_date_5']) ? $employer_verify['expiration_date_5'] : '' }}
                              </td>
                           </tr>
                        </table>
         ...
         <tr>
             <td style="font: bold;"> 
                 <span style="font-size: 12.5px;">Certification</span> :
               ...
               <em>(mm/dd/yyyy)</em>:<span class="sectionBackColor">{{ isset($employer_verify['certification_date']) ? $employer_verify['certification_date'] : '' }}</span> (See instruction for
               exemptions.)
            </td>
         </tr>
         <tr>
            <td class="no-border pad-bottom-5">
                <table class="table-border mr-top-10px" style="margin-top: -4px;">
                  <tr>
                     ...
                     <td>
                        Today's Date <br />
                        {{ isset($employer_verify['signature_date']) ? $employer_verify['signature_date'] : '' }}
                     </td>
                     <td colspan="3">
                        Title of Employer or Authorized Representative<br />
                        Human Resources
                     </td>
                  </tr>
                  <tr>
                        <td  style="width: 20%;">
                           Last Name of Employer or Authorized Repres.<br /> {{ isset($employer_verify['lname']) ? $employer_verify['lname'] : '' }}
                        </td>
                        <td style="width: 20%;">
                           First Name of Employer or Authorized Representative<br /> {{ isset($employer_verify['fname']) ? $employer_verify['fname'] : '' }}
                        </td>
                        <td colspan="3"  style="width: 60%;">
                           Employer's Business or Organization Name<br />
                     ...
                     <tr>
                        ...
                        <td style="width: 15%;">City or Town<br />
                        ...
                        <td style="width: 10%;">Zip Code<br />{{ isset($users->professional_detail['npa_zipCode']) ? $users->professional_detail['npa_zipCode'] : '' }}</td>
                     </tr>
               </table>
            </td>
         </tr>
         <tr>
            <td class="no-border pad-bottom-5">
               <table class="table-border">
                  ...
                  <tr>
                      <td colspan="3" class="sectionSecondBackColor">
                          <b>A. </b> New Name <em>(if applicable)</em>&nbsp;&nbsp;&nbsp; 
                          {{ isset($employer_verify['sec3_newname']) ? $employer_verify['sec3_newname'] : '' }}
                     </td>
                     <td class="sectionSecondBackColor">
                        B. Date of Rehire
                        <em>(if applicable)</em>&nbsp; 
                        {{ isset($employer_verify['sec3_rehire_date']) ? $employer_verify['sec3_rehire_date'] : '' }}
                     </td>
                  </tr>
                  <tr>
                     <td class="">
                        Last Name <em>(Family Name)</em><br />{{ isset($employer_verify['sec3_lname']) ? $employer_verify['sec3_lname'] : '' }}
                     </td>
                     <td class="">
                        First Name <em>(Given Name)</em><br />{{ isset($employer_verify['sec3_fname']) ? $employer_verify['sec3_fname'] : '' }}
                     </td>
                     <td class="">
                        Middle Initial<br />{{ isset($employer_verify['sec3_middle']) ? $employer_verify['sec3_middle'] : '' }}
                     </td>
                     <td class="" >
                        Date 
                        <em>(mm/dd/yyyy)</em><br />{{ isset($employer_verify['sec3_rehire_date']) ? $employer_verify['sec3_rehire_date'] : '' }}
                     </td>
                  </tr>
               </table>
            </td>
         ...
         <tr>
            <td class="no-border pad-bottom-5">
               <table class="table-border">
                   <tr class="">
                     <td  colspan="3" class="sectionSecondBackColor">
                        C. If employee’s previous grant of employment authorization
                        has expired, provide the information for the document or receipt that 
                        establishes continuing employment authorization in the
                  ...
                  <tr>
                     <td style="width: 30%">
                        Document Title<br />
                        {{ isset($employer_verify['sec3_title']) ? $employer_verify['sec3_title'] : '' }}
                     </td>
                     <td style="width: 30%">
                        Document Number<br />
                        {{ isset($employer_verify['sec3_docnumber']) ? $employer_verify['sec3_docnumber'] : '' }}
                     </td>
                     <td style="width: 40%">
                        Expiration Date
                        <em>(if any) (mm/dd/yyyy)</em><br />
                        {{ isset($employer_verify['sec3_expiration_date']) ? $employer_verify['sec3_expiration_date'] : '' }}
                     </td>
                  </tr>
               </table>
            </td>
            ...
            <td class="no-border pad-bottom-5">
               <table class="table-border">
                  <tr>
                     ...
                     <td style="width: 20%">
                        Today's Date<em>(mm/dd/yyyy)</em><br />
                        {{ isset($employer_verify['seclast_date']) ? $employer_verify['seclast_date'] : '' }}
                     </td>
                     <td style="width: 40%">
                        Name of Employer or Authorized Representative<br />
                        <span> {{ isset($employer_verify['seclast_name']) ? $employer_verify['seclast_name'] : '' }}</span>
                     </td>
                  </tr>
               </table>
            </td>
