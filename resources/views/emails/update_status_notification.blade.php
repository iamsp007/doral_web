            ...
            <tr>
              <td valign="top" class="hc_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">{!! $details['message'] !!}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">Thank you for Connecting with DORAL HEALTH CONNECT.
                    </td>
                  </tr>
                  <tr>
                    <td height="30" class="hc_height">&nbsp;</td>
