                            ...
                            <tr>
                                <td valign="top" class="hc_aside">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td align="center" class="hc_txt_20" style="font-family:Montserrat, Arial, sans-serif; font-size:24px; font-weight:700; line-height:26px; color:#24272A;">Hello ,</td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">You are receiving this email because we received a password reset request for your account. </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="280" border="0" cellspacing="0" cellpadding="0" align="center">
                                                        <tbody>
                                                            <tr>     
                                                                ...
                                                                <a href="{{ $actionUrl }}" target="_blank" style="text-decoration:none; color:#ffffff; display:block; line-height:45px;">{{ $actionText }}</a>
                                                                    @endisset
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr>
                                                <td align="" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">TThis password reset link will expire in 60 minutes.</td>
                                            </tr>
                                            <tr>
                                                <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">If you did not request a password reset, no further action is required.</td>
                                            </tr>
                                            <tr>
                                                <td height="30" class="hc_height">&nbsp;</td>
                                            </tr>
