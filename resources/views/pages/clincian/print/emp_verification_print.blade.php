...
<html lang="en">
    ...
    @foreach ($users->employer_detail['employer'] as $employer_detail)
        <div class="container">
            ...
            <p> <b>Name of Applicant:</b>  <span>{{ ($users->user) ? $users->user->first_name : '' }} {{ ($users->user) ? $users->user->last_name : '' }}</span> <b> SSN#:</b><span>@if (isset($users->address_detail['info']))
            ...
            @endphp
                ...
                <p><b>Address:</b> <span>{{ $employer_detail['address1'] }},
...
{{ isset($employer_detail['zipcode']) ? $employer_detail['zipcode'] : '' }}</span></p> 
                <!--<p><b>City, State, Zip: </b><span></p>-->
            </div>
            <p> </p><b>Applicant's Authorization Release:</b>  I hereby authorize the release of any information requested by Pella Care concerning my employement in your company.</p>
            <p> <b> Applicant's signature:</b> 
            <span>
            @if($users->signature_url)
                <img
                      src="{{ $users->signature_url }}"
                      style="display: inline-block; width: 90px; height: auto"
                   />
                   @endif
            </span> <b> Date:</b> <span> {{date('m/d/Y')}}</span></p>
            <div class="box" style="text-align: center;">
                <b>DO NOT WRITE BELOW THIS BOX ~ TO BE COMPLETED BY EMPLOYER ONLY</b>
            </div>
            <p>
                Dear Sir/Madam, <br>
                The person listed has given your name as a source of refrence and has also signed a statement authorizing the inquiry. We would appreciate a statement of your experiences with this person, and an assessment of his/her potential in your openion. Any information released will be held in strict confidence. <br>
        ...
        <div class="container">
            ...
            <p> <b>Name of Applicant:</b>  <span></span></p>
            <div class="box">
