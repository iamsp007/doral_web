            ...
            <tbody>
                                ...
                                <td>
                                    <table style="width: 100%; border: 1px solid #a5a5a5;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 20%;text-align: left;text-align: center; border-top: 1px solid #a5a5a5; ">
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <tr>
                    <td style="display: flex; justify-content: center;">
                        <table style="width: 1100px;margin-top: 15px;">
                            <tr>
                                <td style="width: 10%;text-align: left;">* If PPD RESUTLTS are positive you must have:</td>
                            </tr>
                            <tr>
                                <td style="width: 10%;text-align: left; padding-left: 30px;">1. Report of Chest X-Ray</td>
                            </tr>
                            <tr>
                                <td style="width: 10%;text-align: left; padding-left: 30px;">2. Annual Tuberculosis Screening Questionnaire Form</td>
                            </tr>
                            <tr>
                                <td style="width: 10%;text-align: left;">If your test result is negative: Please provide the date & result information on the physical form.</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                            ...
                                            <!-- <tr>
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td>
                                                                <p>Have you worked for this company in the past<span><input type="checkbox" checked>Yes
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <p>Phone No: <span>{{ isset($emergency_detail['phoneNo']) ? $emergency_detail['phoneNo'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Address line 1: <span>{{ isset($emergency_detail['address_line_1']) ? $emergency_detail['address_line_1'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <p>Address line 2: <span>{{ isset($emergency_detail['address_line_2']) ? $emergency_detail['address_line_2'] : ''}}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Apt/Building#: <span>{{ isset($emergency_detail['building']) ? $emergency_detail['building'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <p>Relationship: <span>{{ isset($emergency_detail['relation']) ? $emergency_detail['relation'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>How is this person related to yop?: <span>{{ isset($emergency_detail['personRelation']) ? $emergency_detail['personRelation'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <p>Father Name: <span>{{ ($users->family_detail) ? $users->family_detail['father_name'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Mother Name: <span>{{ ($users->family_detail) ? $users->family_detail['mother_name'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <p>Spouse Name: <span>{{ ($users->family_detail) ? $users->family_detail['spouse_name'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Parents Name: <span>{{ ($users->family_detail) ? $users->family_detail['parents_name'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <p>Children Name: <span>{{ ($users->family_detail) ? $users->family_detail['children_name'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Siblings Name: <span>{{ ($users->family_detail) ? $users->family_detail['siblings_name'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <p>Father In Low Name: <span>{{ ($users->family_detail) ? $users->family_detail['father_in_low_name'] : '' }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Mother In Low Name: <span>{{ ($users->family_detail) ? $users->family_detail['mother_in_low_name'] : '' }}</span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <!-- past three (3) -->
                                                                                    <p>List your employers, beginning with the most recent: <span></span></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td>
                                                                            <p>List your schhols you attended, beginning with the most recent. <span></span></p>
                                                                        </td> 
                                                                    </tr>
                                                                </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td>
                                                                                <p>Have you ever been bonded: <span>{{ $users->security_detail ? $users->security_detail['bond'] : '' }}</span></p>
                                                                            </td>
                                                                            <td>
                                                                                <p>If so,exaplain: <span>{{ $users->security_detail ? $users->security_detail['bond_explain'] : '' }}</span></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td>
                                                                                <p>Have you been convicted of a falcony within the last 5 years?: <span>{{ $users->security_detail ? $users->security_detail['convict'] : '' }}</span></p>
                                                                            </td>
                                                                            <td>
                                                                                <p>If so,exaplain(this will not necessarily exclude you from consideration): <span>{{ $users->security_detail ? $users->security_detail['convict_explain'] : '' }}</span></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            @if (isset($users->military_detail['isMilitary']))
                                                                                ...
                                                                                <td>
                                                                                    <p>Serve End Date: <span>{{ ($users->military_detail['serve_end_date']) }}</span></p>
                                                                                </td>
                                                                                <td>
                                                                                    <p>Serve Start Date: <span>{{ ($users->military_detail['serve_start_date']) }}</span></p>
                                                                                </td>
                                                                            @endif
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td>
                                                                                <p>Skills: <span>{{ $users->language_detail ? $users->language_detail['skill'] : '' }}</span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
