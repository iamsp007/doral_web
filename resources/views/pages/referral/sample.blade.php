...
<head>
    ...
    <title>Non-Skilled Application - Consumer Enrollment Packet</title>
...
<meta name="x-stylesheet-fallback-test" content="" class="sr-only" /><script>!function(a,b,c,d){var e,f=document,g=f.getElementsByTagName("SCRIPT"),h=g[g.length-1].previousElementSibling,i=f.defaultView&&f.defaultView.getComputedStyle?f.defaultView.getComputedStyle(h):h.currentStyle;if(i&&i[a]!==b)for(e=0;e<c.length;e++)f.write('<link href="'+c[e]+'" '+d+"/>")}("position","absolute",["/lib/bootstrap/dist/css/bootstrap.min.css"], "rel=\u0022stylesheet\u0022 crossorigin=\u0022anonymous\u0022 integrity=\u0022sha384-ggOyR0iXCbMQv3Xipma34MD\u002BdH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T\u0022 ");</script>
        <link href="/lib/coreui/coreui/dist/css/coreui.min.css" rel="stylesheet" />
    
    <link rel="stylesheet" href="/css/site.css?v=dzqGptAJWkoog4Vo-_5wUJ_qez0Slx1BKruoZR4Iyyw" />
...
<body>
    <header>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="/">Consumer Enrollment Packet</a>
    ...
    <li class="nav-item">
        <a href="#Demographics" class="nav-link active" data-toggle="tab" data-ajax="true" id="tabDemographics">Demographics</a>
    </li>
        <li class="nav-item">
            <a href="#ReferenceAndContact" class="nav-link" data-toggle="tab" data-ajax="true" id="tabReferenceAndContact">Contacts & References</a>
        </li>
    <li class="nav-item">
        <a href="#Education" class="nav-link" data-toggle="tab" data-ajax="true" id="tabEducation">Education</a>
    </li>
    <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="b-a-1 rounded p-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 col-sm-6">
                                        <label for="inputStaus">Meritial Status</label>
                                    ...
                                    <div class="form-group col-md-2 col-sm-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Height" autoComplete="off" id="Height" name="Height" value="">
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6">
                                        <label for="Weight">Weight</label>
                                        <input type="text" class="form-control" placeholder="Enter Weight" autoComplete="off" id="Weight" name="Weight" value="">
                                    </div>
                                    <div class="form-group col-md-2 col-sm-6">
                                        <label for="inputeyecolor">Eye Color</label>
                                        <select class="form-control select2" id="EyeColor" name="EyeColor">
...
<option value="2">Brown</option>
                                    ...
                                    <div class="form-group col-md-3 col-sm-6">
                                        ...
                                        <select class="form-control select2" id="HairColor" name="HairColor"><option value="1">Black</option>
<option value="2">White</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="number" min="0" class="form-control" placeholder="Enter SSN" autocomplete="off" data-val="true" data-val-range="Enter valid SSN" data-val-range-max="999999999" data-val-range-min="1" data-val-required="The SSN field is required." id="SSN" name="SSN" value="" />
                                    ...
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" maxlength="15" class="form-control" placeholder="Enter Driving Licence Number" autocomplete="off" id="DrivingLicenseNumber" name="DrivingLicenseNumber" value="" />
                                        <span class="text-danger field-validation-valid" data-valmsg-for="DrivingLicenseNumber" data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                                        <label for="ElianNumber">Alien Number</label>
                                        <input type="text" class="form-control" placeholder="Enter Alien Number" autocomplete="off" id="ElianNumber" name="ElianNumber" value="" />
                                        <span class="text-danger field-validation-valid" data-valmsg-for="ElianNumber" data-valmsg-replace="true"></span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Referred by" autocomplete="off" id="ReferredBy" name="ReferredBy" value="" />
                                        <span class="text-danger field-validation-valid" data-valmsg-for="ReferredBy" data-valmsg-replace="true"></span>
                                    </div>

                                    <div class="form-group col-md-4 col-sm-6">
                                        <label for="MaidenMotherName">Maiden Mother Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Maiden Mother Name" autocomplete="off" id="MaidenMotherName" name="MaidenMotherName" value="" />
                                        <span class="text-danger field-validation-valid" data-valmsg-for="MaidenMotherName" data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                                        <label for="Alias">Alias</label>
                                        <input type="text" class="form-control" placeholder="Enter Alias" autocomplete="off" id="Alias" name="Alias" value="" />
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="b-a-1 rounded p-4 mt-4 mt-md-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-6">
                                        <label for="AddressEntity_Borough">Borough</label>
                                        <input type="text" class="form-control" placeholder="Enter Borough" autoComplete="off" id="AddressEntity_Borough" name="AddressEntity.Borough" value="">
                                    </div>
                                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <div class="col-md-6">
                            <div class="b-a-1 rounded p-4 mt-4 mt-md-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 form-group">
                                        <label for="RefRelationShip1">Relation Ship</label>
                                        <input placeholder="Enter Relationship" class="form-control" type="text" autocomplete="off" id="RefRelationShip1" name="RefRelationShip1" value="">
                                    </div>
                                    <div class="col-md-4 col-sm-6 form-group">
                                        <label for="RefTimeKnown1">Time Known</label>
                                        <input placeholder="Enter Time Known" class="form-control" type="text" autocomplete="off" id="RefTimeKnown1" name="RefTimeKnown1" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8 col-sm-6 form-group">
                                        <label for="RefAddress1">Address</label>
                                        <input type="text" placeholder="Enter Address" class="form-control" autocomplete="off" id="RefAddress1" name="RefAddress1" value="">
                                    </div>
                                    <div class="col-md-4 col-sm-6 form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 form-group">
                                        <label for="RefRelationShip2">Relation Ship</label>
                                        <input placeholder="Enter Relationship" class="form-control" type="text" autocomplete="off" id="RefRelationShip2" name="RefRelationShip2" value="">
                                    </div>
                                    <div class="col-md-4 col-sm-6 form-group">
                                        <label for="RefTimeKnown2">Time Known</label>
                                        <input placeholder="Enter Time Known" class="form-control" type="text" autocomplete="off" id="RefTimeKnown2" name="RefTimeKnown2" value="">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8 col-sm-6 form-group">
                                        <label for="RefAddress2">Address</label>
                                        <input type="text" placeholder="Enter Address" class="form-control" autocomplete="off" id="RefAddress2" name="RefAddress2" value="">
                                    </div>
                                    <div class="col-md-4 col-sm-6 form-group">
                                        <label for="RefPhoneNumber2">Reference Phone</label><span class="text-danger"> *</span>
                                        <input type="text" placeholder="Enter Phone" class="form-control" autocomplete="off" data-val="true" data-val-phone="Not valid phone number" data-val-required="The Reference Phone field is required." id="RefPhoneNumber2" name="RefPhoneNumber2" value="">
                                        <span class="text-danger field-validation-valid" data-valmsg-for="RefPhoneNumber2" data-valmsg-replace="true">
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="b-a-1 rounded p-4 mt-4 mt-md-0">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="EmerRelationShip1">Relation Ship</label>
                                            <input type="text" class="form-control" placeholder="Enter Relationship to Employee" autocomplete="off" id="EmerRelationShip1" name="EmerRelationShip1" value="">
                                        </div>
                                    </div>
                                   <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="EmerAddress1">Address</label>
                                            <input type="text" class="form-control" placeholder="Enter Address" autocomplete="off" id="EmerAddress1" name="EmerAddress1" value="">
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="EmerRelationShip2">Relation Ship</label>
                                            <input type="text" class="form-control" placeholder="Enter Relationship to Employee" autocomplete="off" id="EmerRelationShip2" name="EmerRelationShip2" value="">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="EmerAddress2">Address</label>
                                            <input type="text" class="form-control" placeholder="Enter Address" autocomplete="off" id="EmerAddress2" name="EmerAddress2" value="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
...
<input name="__RequestVerificationToken" type="hidden" value="CfDJ8EuV0NPboZ1Alha0wXfSm4VR2ER6_cbHk5a6xH3z6WeDBD0-RJyhGyUxDnOGS3LibWTdsdyl9m3rAURzXZvgDa4Jo6JvEtmiNsKGud-_gL4OzIJ2eEHfZXLU15IbCv1FfigzES2shwjPtaeoQY1DIuY" /></form>
    ...
    <footer class="border-top footer text-muted">
        <div class="container">
            &copy; 2021 - Consumer Enrollment Packet - <a href="/Home/Privacy">Privacy</a>
        </div>
    </footer>
...
<script>(window.jQuery && window.jQuery.fn && window.jQuery.fn.modal||document.write("\u003Cscript src=\u0022/lib/bootstrap/dist/js/bootstrap.bundle.min.js\u0022 crossorigin=\u0022anonymous\u0022 integrity=\u0022sha384-xrRywqdh3PHs8keKZN\u002B8zzc5TX0GRTLCcmivcbNJWm2rs5C8PRhcEn3czEjhAO9o\u0022\u003E\u003C/script\u003E"));</script>
    ...
    <script src="/js/nonSkilledIndex.js"></script>
