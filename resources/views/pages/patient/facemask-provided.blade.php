...
<div class="tab-pane fade" id="facemask-provided" role="tabpanel"
   ...
   <div class="app-vbc p-3">
      <div class="add-new-patient">
         <div class="icon"><img src="{{ asset('assets/img/icons/facemask.svg') }}"
               class="img-fluid" /></div>
         <button type="submit"
         class="btn btn-outline-green w-600 d-table mr-auto ml-auto mt-3" id="facemaskbtn" style="width: inherit;font-size: 18px;height: 36px;padding-left: 10px;padding-right: 10px;text-transform: uppercase;"
         onclick="openRoadL('facemaskbtn')" name="RoadL Request">RoadL
         Request</button>       
