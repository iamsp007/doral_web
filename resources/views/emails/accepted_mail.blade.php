                                ...
                                <td valign="top" class="hc_aside">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center" class="hc_txt_14" style="font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:22px; font-weight: 400; color:#707070;">Thank you for Registration with <b>DORAL HEALTH CONNECT. </b>Your email address accepted by admin.You can log in with the login details given below.</td>
                                            </tr>
                                            <tr>
