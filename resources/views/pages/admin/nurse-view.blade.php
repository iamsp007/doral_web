                  ...
                  <ul class="list-group">
                     ...
                     @if(isset($data->background) && isset($data->phone))
                        <li class="list-group-item d-inherit">
                           ...
                           @endif
                           @isset($applicant->phone)
                           @php
                              $cellphone =  "+".substr($applicant->phone, 0, 1). " (".substr($applicant->phone, 1, 3).") ".substr($applicant->phone, 4, 3)."-".substr($applicant->phone,7);
                           @endphp
                                 ...
                                 <div>
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div>
                                          ...
                                          <h1 class="_detail">{{ $home_phone }}</h1>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div class="card-body collapse show" id="collapseWork" aria-labelledby="collapseWork" data-parent="#profileAccordion">
                     ...
                     <div class="row mt-3">
                        <div class="col-12 col-sm-12">
                           <div class="_card mt-3">
                              @php
                                 $malpractice_Insurance = ($document_information) ? $document_information->malpractice_Insurance : '';
                                 $ECFMG_Info = ($document_information) ? $document_information->ECFMG_Info : '';
                              @endphp
