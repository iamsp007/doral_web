            ...
            <tr>
                <td>
                    <p>Have you served in military?
                        <span>
                            <input type="radio" {{ isset($users->military_detail['isMilitary']) ? 'checked' : '' }}>Yes
                            <input type="radio"{{ isset($users->military_detail['isMilitary']) ? '' : 'checked' }}>No
                        </span>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p>Do you have any military commitment, including National Guard service that would influence your work schedule?  
                        <span>
                            <input type="radio" {{ isset($users->military_detail['isCommited']) ? 'checked' : '' }}>Yes
                            <input type="radio" {{ isset($users->military_detail['isCommited']) ? '' : 'checked' }}>No
                        </span>
                    </p>
                </td> 
            </tr>
            ...
            <tr>
                <td>
                    <p>Are you a Vietnam veteran?  
                        <span>
                            <input type="radio" {{ isset($users->military_detail['isVietnam']) ? 'checked' : '' }}>Yes
                            <input type="radio"{{ isset($users->military_detail['isVietnam']) ? '' : 'checked' }}>No
                        </span>
                    </p>
                </td> 
                <td>
                    <p>Are you a disabled veteran? 
                        <span>
                            <input type="radio" {{ isset($users->military_detail['isDisableVetran']) ? 'checked' : '' }}>Yes
                            <input type="radio" {{ isset($users->military_detail['isDisableVetran']) ? '' : 'checked' }}>No
                        </span>
                    </p>
                </td> 
            </tr>
            ...
            <tr>
                <td>
                    <p>Are you a special disabled veteran?
                        <span>
                            <input type="radio" {{ isset($users->military_detail['isSpecialDisableVereran']) ? 'checked' : '' }}>Yes
                            <input type="radio" {{ isset($users->military_detail['isSpecialDisableVereran']) ? '' : 'checked' }}>No
                        </span>
                    </p>
                </td> 
            </tr>
...
@if(isset($users->military_detail['isCommited']))
<tr>
    <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
