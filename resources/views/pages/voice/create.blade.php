            ...
            <div class="panel-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset('assets/vonage/img/archiving-on-message.png') }}"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Archiving remains on</td>
                        <td><img src="{{ asset('assets/vonage/img/archiving-on-idle.png') }}"></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Archiving is stopped</td>
                        <td><img src="{{ asset('assets/vonage/img/archiving-off.png') }}"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
